...
if __name__ == "__main__":
    ...
    if 'emomodel' in config:
        test_cmd = "python3 " + "controllers/manualtest.py" + " " + os.path.join(config['logs'], "logs/", config['model']) + " " + os.path.join(config['logs'], "emo/", config['emomodel'])
    else:
        test_cmd = "python3 " + "controllers/manualtest.py" + " " + os.path.join(config['logs'], "logs/", config['model'])

    test_cmd = "python3 " + "controllers/manualtest.py"
